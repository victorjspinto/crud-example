...
public class EmployeeController {
	...
	@RequestMapping(value = REQUEST_ROOT + "/{id}", method = RequestMethod.DELETE, produces = "application/json")
	@ResponseBody
	...
	@RequestMapping(value = REQUEST_ROOT + "/new", method = RequestMethod.GET)
	@ResponseBody
